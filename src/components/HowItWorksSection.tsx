    ...
    <section id="how-we-work" className="py-32 relative overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="relative">
          {/* Central Line */}
          <div className="absolute start-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 via-orange-500 to-emerald-500 -translate-x-1/2 rtl:translate-x-1/2 hidden md:block" />
          ...
          <div className="space-y-10 md:space-y-24">
            {timelineSteps.map((step, i) => (
              <motion.div
                ...
                className={`flex flex-col md:flex-row items-center justify-between w-full ${step.side === 'left' ? 'md:flex-row-reverse rtl:md:flex-row' : 'rtl:md:flex-row-reverse'}`}
              >
                {/* Text Side */}
                <div className="w-full md:w-[45%] text-start md:text-end group">
                  <div className={`p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-all hover:border-white/10 ${step.side === 'right' ? 'md:text-start' : ''}`}>
                ...
                {/* Number Side */}
                <div className="absolute start-1/2 -translate-x-1/2 rtl:translate-x-1/2 hidden md:flex items-center justify-center z-10">
